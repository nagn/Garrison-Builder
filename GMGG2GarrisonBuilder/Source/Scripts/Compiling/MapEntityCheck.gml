...
strayEntityFix();
  ...
  var neutralIntelExists, neutralIntelSpawnExists, capsExist, cap1Exist, cap2Exist, cap3Exist, cap4Exist, cap5Exist, bluIntelSpawnExists, redIntelSpawnExists, bluIntelExists, redIntelExists, sufficientCapMats, ArenacpExist, GenBlueExist, GenRedExist;
  ...
  // Generators.
        ...
        if (ArenacpExist == true && sufficientCapMats == false || ArenacpExist == false  && sufficientCapMats == true) 
        {
    // For the Arena maps.
